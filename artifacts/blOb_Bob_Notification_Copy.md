...
## Suggested categories (not written yet)

Add these when we lock the eleven above:
...
- **Flag you filed was reviewed**.
- **Finished the tournament** (finisher).
- **Prize posted to wallet**.
- **Created a challenge, nobody joined yet**.
- **First friend accepted** (people event, not only coins).
- **Early morning check-in** (before 7 a.m. local).
- **Honor-only day** vs **proof-required day**.
- **Top-up needed to enter** (wallet short).
- **Removed for bad proof** (vs miss) — shorter, stricter.
- **7-day streak / 30-day streak** (beyond 5+).
- **Came back and checked in the same day** (reward the return).
