...
const STRINGS = {
  ...
  'capture.saveDenied': 'Save to Photos is off. Turn it on in iPhone Settings → blOb.',
  'capture.saveDeniedAndroid': 'Save to Photos is off. Turn it on in Settings → blOb.',
