...
export const extraCreateTaskSchema = z.object({
  ...
  title: z.string(),
  once: z.boolean(),
  frequency: z.enum(['once', 'daily', '3x_week', 'custom']).optional(),
  custom_checkins: z.number().int().min(1).max(100).optional(),
  custom_period: z.enum(['day', 'week', 'month', 'duration']).optional(),
